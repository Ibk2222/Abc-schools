...
const EMPTY_FORM = { title: '', description: '', class_id: '', subject_id: '', due_date: '', questions: [{ text: '', type: 'text', options: ['', ''] }] }
        ...
        <div className={style.container}>
            <div className={style.header}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: 12 }}>
                    <div>
                        ...
                        <p className={style.subtitle}>Create and manage assignments for your classes</p>
                    </div>
            ...
            {loading ? (
                ...
                <div className={style.tableCard}>
                    ...
                    {assignments.length === 0 ? (
                        <p className={style.empty}>No assignments yet. Click "+ New Assignment" to get started.</p>
                    ) : (
                            ...
                            <tbody>
                                {assignments.map((a, i) => (
                                    <tr key={a._id}>
                                        ...
                                        <td><span className={style.scoreBadge}>{a.questions?.length ?? 0} Qs</span></td>
                                        <td>
            ...
            {modal && (
                <div className={style.overlay} onClick={e => e.target === e.currentTarget && setModal(false)}>
                    <div className={style.sheetModal} style={{ maxWidth: 680 }}>
